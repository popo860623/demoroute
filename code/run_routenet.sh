...
if [[ "$1" = "train" ]]; then
    ...
    python3 routenet_with_link_cap.py train --hparams="l2=0.01,dropout_rate=0.5,link_state_dim=64,path_state_dim=64,readout_units=256,learning_rate=0.0001,T=4"  --train  $2/tfrecords/train/*.tfrecords --train_steps $3 --eval_ $2/tfrecords/evaluate/*.tfrecords --model_dir ./CheckPoints/
